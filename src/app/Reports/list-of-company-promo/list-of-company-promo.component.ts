...
@Component({
  selector: 'app-list-of-company-promo',
  templateUrl: './list-of-company-promo.component.html',
  styleUrls: ['./list-of-company-promo.component.scss']
})
export class ListOfCompanyPromoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.global.setHeaderTitle('List of Company Promo');
